...
const FIXTURE = resolve(__dirname, '../tests/fixtures/football.webp');
const OUT_DIR = resolve(__dirname, '../.halo-check');

test.describe.configure({ mode: 'serial' });

test('capture football output + mirror console/network', async ({ page }, testInfo) => {

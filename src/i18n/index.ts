...
const translations: Translations = {
  en: {
    ...
    'pwa.guideFirefox': '1. Tap \u22EF (three dots, bottom bar)<br>2. Tap "\u2026 More"<br>3. Tap "Install"',
  ...
  es: {
    ...
    'pwa.guideFirefox': '1. Toca \u22EF (tres puntos, barra inferior)<br>2. Toca "\u2026 M\u00E1s"<br>3. Toca "Instalar"',
  ...
  fr: {
    ...
    'pwa.guideFirefox': '1. Appuie sur \u22EF (trois points, barre du bas)<br>2. Appuie sur "\u2026 Plus"<br>3. Appuie sur "Installer"',
  ...
  de: {
    ...
    'pwa.guideFirefox': '1. Tippe auf \u22EF (drei Punkte, untere Leiste)<br>2. Tippe auf "\u2026 Mehr"<br>3. Tippe auf "Installieren"',
  ...
  pt: {
    ...
    'pwa.guideFirefox': '1. Toca em \u22EF (tr\u00EAs pontos, barra inferior)<br>2. Toca em "\u2026 Mais"<br>3. Toca em "Instalar"',
  ...
  zh: {
    ...
    'pwa.guideFirefox': '1. \u70B9\u51FB\u5E95\u90E8\u680F \u22EF\uFF08\u4E09\u4E2A\u70B9\uFF09<br>2. \u70B9\u51FB\u300C\u2026 \u66F4\u591A\u300D<br>3. \u70B9\u51FB\u300C\u5B89\u88C5\u300D',

...
const translations: Translations = {
  ...
  es: {
    ...
    'advanced.restoreHint': 'Reemplaza el estado actual por la imagen original. Pod\u00E9s deshacer con Ctrl+Z.',
    ...
    'advanced.actionRefineHint': 'Volv\u00E9 a correr RMBG dentro del lazo para corregir un error (pelos, bordes, fondo colado).',
    ...
    'advanced.previewApplyHint': 'Confirma el cambio previsualizado. Con Ctrl+Z pod\u00E9s deshacer.',
    'advanced.previewCancelHint': 'Descarta la vista previa. El lazo queda para que pruebes otra acci\u00F3n.',
    'advanced.previewHint': 'Vista previa \u2014 rojo = se va a borrar, verde = se va a recuperar. Aplic\u00E1 para confirmar.',
    ...
    'advanced.helpLassoDesc': 'Dibuj\u00E1 un lazo a mano alzada para seleccionar una zona. Arrastr\u00E1 los puntos para ajustar, doble clic borra uno.',
    'advanced.helpPreviewNote': 'Cada acci\u00F3n del lazo muestra una vista previa: rojo = se va a borrar, verde = se va a recuperar. Aplic\u00E1 para confirmar.',
    'advanced.helpControlsDesktop': 'Teclado y mouse',

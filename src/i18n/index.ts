...
const translations: Translations = {
  ...
  es: {
    ...
    'editor.canvasLabel': 'Lienzo del editor. Usá pincel para restaurar, borrador para quitar.',
    ...
    'advanced.actionRemoveWatermark': 'quitar watermark',
    'advanced.actionRemoveWatermarkHint': 'Reconstruye los pixeles dentro del lazo (PatchMatch inpaint). A diferencia de erase-object: deja la foto natural en vez de un agujero transparente. Mejor para watermarks, logos y marcas no deseadas.',
    'advanced.removeWatermarkError': 'Falló el remove-watermark. Mira la consola.',
    ...
    'reactor.removalNotice': 'Si aparecés en esta página y querés que te saquemos, mandá mail a yocreoquesi arroba gmail punto com — resuelto en 7 días, sin preguntas.',
    'reactor.noSupportersYet': 'Sin supporters todavía — el shipeo de código está financiado actualmente por el bolsillo del maintainer. Alimentá abajo para extender el runway.',
